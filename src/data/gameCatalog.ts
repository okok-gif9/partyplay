...
export const gameCatalog: GameDefinition[] = [
  ...
  { id: 'hokm', title: 'حکم', subtitle: 'در جست‌وجوی موتور حرفه‌ای و قابل استقرار', players: '۴ نفر', duration: '۱۵ تا ۳۰ دقیقه', tone: 'در حال پژوهش', icon: Swords, accent: 'orange', art: '♠', online: false, availability: 'research' },
