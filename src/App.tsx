...
function App() {
  ...
  const startPractice = (game: GameId) => {
    ...
    if (game === 'snakes' || game === 'ludo' || game === 'connect-four' || game === 'uno') {
      setSelectedGame(game)
      setPage('game')
      const readyMessage = game === 'ludo' ? 'منچ با ربات آماده است.' : game === 'connect-four' ? 'چهاردرردیف با ربات آماده است.' : game === 'uno' ? 'اونو با ربات آماده است.' : 'مارپله با ربات آماده است.'
